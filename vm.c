...
uint 
num_of_PhysPages(pde_t* pgdir, uint size)
{ 
  int count = 0;  //use PTE_P (Present bit)
...
uint 
num_of_PTPages(pde_t* pgdir, uint size)
{ 
  int count = 0;  //use PTE_P (Present bit)
